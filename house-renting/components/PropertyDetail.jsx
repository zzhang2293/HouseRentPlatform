  ...
  return (
    <main>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mt-6">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 list-none space-x-3 space-y-2">
          {property.amenities.map((amenity, index) => (
            <li key={index}>
              <FaCheck className="text-green-600 mr-2 inline-block text-green-600"></FaCheck>{" "}
              {amenity}
            </li>
          ))}
        </ul>
